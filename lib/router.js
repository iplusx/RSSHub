...
// BBC SPORT
router.get('/bbc/sport/:channel?', require('./routes/bbc/sport'));
...
// 中国体育
router.get('/zhibotv/room/:id', require('./routes/zhibotv/room'));
...
// World Snooker
router.get('/worldsnooker', require('./routes/worldsnooker/index'));

// WPBSA
router.get('/wpbsa', require('./routes/wpbsa/index'));

// Snookerbacker
router.get('/snookerbacker', require('./routes/snookerbacker/index'));
